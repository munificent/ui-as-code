...
import '../fasta/parser/parser.dart';
...
class SimpleToken implements Token {
  ...
  set previous(value) => _previous = value;
  Token _previous;
...
class TokenType {
  ...
  // DONE(semicolon): This is a synthetic "semicolon" token generated from a
  // newline. It's treated as a separate token type because there are places
  // where we allow and ignore an implicit semicolon but don't allow a real
  // one.
  static const TokenType SEMICOLON_IMPLICIT =
      const TokenType('¶', 'SEMICOLON_IMPLICIT', NO_PRECEDENCE, 182);
